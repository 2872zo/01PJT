...
<%
	SimpleDateFormat bfDate = new SimpleDateFormat("yyyymmdd");
	SimpleDateFormat afDate = new SimpleDateFormat("yyyy-mm-dd");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01"><%=afDate.format(bfDate.parse(productVO.getManuDate()))%></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 10px;">
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<%if(userVO != null && userVO.getRole().equals("user") && productVO.getProTranCode() == null){ %>
