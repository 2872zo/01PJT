	...
	<tr>
		...
		<td class="ct_write01">
			<select 	name="paymentOption" 	class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20">
				<option value="1" <%if(purchaseVO.getPaymentOption().equals("1")){ %>selected="selected"<%} %>>현금구매</option>
				<option value="2" <%if(purchaseVO.getPaymentOption().equals("2")){ %>selected="selected"<%} %>>신용구매</option>
			</select>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td width="200" class="ct_write01">
			<input type="text" readonly="readonly" name="divyDate" class="ct_input_g" 
						style="width: 100px; height: 19px" maxLength="20" value="<%=purchaseVO.getDlvyDate() %>"/>
